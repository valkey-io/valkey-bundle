...
## Official releases
- [`8.1.4`, `8.1`, `8`, `latest`, `8.1.4-bookworm`, `8.1-bookworm`, `8-bookworm`, `bookworm`](https://github.com/valkey-io/valkey-bundle/blob/mainline/8.1/debian/Dockerfile)
- [`8.1.4-alpine`, `8.1-alpine`, `8-alpine`, `alpine`](https://github.com/valkey-io/valkey-bundle/blob/mainline/8.1/alpine/Dockerfile)
